...
/** GenesisState defines the validators module's genesis state. */
...
export const GenesisState = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.historicalInfoList.push(
  ...
  fromJSON(object: any): GenesisState {
    ...
    if (
      object.historicalInfoList !== undefined &&
  ...
  toJSON(message: GenesisState): unknown {
    ...
    if (message.historicalInfoList) {
      obj.historicalInfoList = message.historicalInfoList.map((e) =>
