...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   */
  queryNextTransaction = (params: RequestParams = {}) =>
    this.request<MultisigwalletQueryGetNextTransactionResponse, RpcStatus>({
      path: `/threefoldtech/threefoldhub/multisigwallet/next_transaction`,
      method: "GET",
      format: "json",
      ...params,
    });
  ...
  queryParams = (params: RequestParams = {}) =>
    this.request<MultisigwalletQueryParamsResponse, RpcStatus>({
      path: `/threefoldtech/threefoldhub/multisigwallet/params`,
      method: "GET",
      format: "json",
      ...params,
    });
  ...
  queryTransactionAll = (
    ...
    this.request<MultisigwalletQueryAllTransactionResponse, RpcStatus>({
      path: `/threefoldtech/threefoldhub/multisigwallet/transaction`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   */
  queryTransaction = (index: string, params: RequestParams = {}) =>
    this.request<MultisigwalletQueryGetTransactionResponse, RpcStatus>({
      path: `/threefoldtech/threefoldhub/multisigwallet/transaction/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
  ...
  queryWalletAll = (
    ...
    this.request<MultisigwalletQueryAllWalletResponse, RpcStatus>({
      path: `/threefoldtech/threefoldhub/multisigwallet/wallet`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   */
  queryWallet = (index: string, params: RequestParams = {}) =>
    this.request<MultisigwalletQueryGetWalletResponse, RpcStatus>({
      path: `/threefoldtech/threefoldhub/multisigwallet/wallet/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
