...
export class Api extends HttpClient {
    constructor() {
         ...
         */
        this.queryNextTransaction = (params = {}) => this.request({
         ...
         */
        this.queryTransactionAll = (query, params = {}) => this.request({
         ...
         */
        this.queryTransaction = (index, params = {}) => this.request({
         ...
         */
        this.queryWalletAll = (query, params = {}) => this.request({
         ...
         */
        this.queryWallet = (index, params = {}) => this.request({
