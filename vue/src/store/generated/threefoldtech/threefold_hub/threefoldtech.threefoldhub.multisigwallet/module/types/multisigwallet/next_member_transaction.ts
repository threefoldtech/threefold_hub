...
const baseNextMemberTransaction: object = { idValue: 0 };

export const NextMemberTransaction = {
  encode(
  ...
  decode(input: Reader | Uint8Array, length?: number): NextMemberTransaction {
    ...
    const message = { ...baseNextMemberTransaction } as NextMemberTransaction;
  ...
  fromPartial(
    object: DeepPartial<NextMemberTransaction>
