...
const baseNextTransaction: object = { idValue: 0 };

export const NextTransaction = {
  encode(message: NextTransaction, writer: Writer = Writer.create()): Writer {
  ...
  decode(input: Reader | Uint8Array, length?: number): NextTransaction {
    ...
    const message = { ...baseNextTransaction } as NextTransaction;
