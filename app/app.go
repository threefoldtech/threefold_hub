...
import (
	...
	"github.com/threefold/threefold_hub/docs"
...
func New(
	...
	app.ThreefoldhubKeeper = *threefoldhubmodulekeeper.NewKeeper(
		appCodec,
		keys[threefoldhubmoduletypes.StoreKey],
		keys[threefoldhubmoduletypes.MemStoreKey],
		app.GetSubspace(threefoldhubmoduletypes.ModuleName),
	)
